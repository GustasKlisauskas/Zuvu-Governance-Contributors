...
contract GovernanceTest is Test {
    ...
    function test_StakingRewards() public {
        ...
        assertApproxEqAbs(gov.stakerRewards(g1), util_convertZuvuDecimals(72_727), accuracyTreshold);  // the reward should be 72_727.2727...
        vm.prank(g1);
        gov.claimReward();
        ...
        assertApproxEqAbs(gov.stakerRewards(g2), util_convertZuvuDecimals(48_484), accuracyTreshold);  // the reward should be 72_727.2727...
        assertApproxEqAbs(gov.stakerRewards(g3), util_convertZuvuDecimals(36_363), accuracyTreshold);  // the reward should be 72_727.2727...
        assertApproxEqAbs(gov.stakerRewards(g4), util_convertZuvuDecimals(24_242), accuracyTreshold);  // the reward should be 72_727.2727...
        assertApproxEqAbs(gov.stakerRewards(g5), util_convertZuvuDecimals(18_181), accuracyTreshold);  // the reward should be 72_727.2727...
    }
}
